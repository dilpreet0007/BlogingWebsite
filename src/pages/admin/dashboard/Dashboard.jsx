                ...
                <div
                    ...
                    <div className="left">
                        <img
                            ...
                            src={'https://static.thenounproject.com/png/5163895-200.png'} alt="profile"
                        />
                    </div>
                    <div className="right">
                        <h1
                        ...
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">dilpreet.sandhu2004@gmail.com
                        </h2>
                        ...
                        <div className="relative overflow-x-auto shadow-md sm:rounded-xl">
                            ...
                            <table className="w-full border-2 border-white shadow-md text-sm text-left text-gray-500 dark:text-gray-400" >
                                ...
                                <thead
                                    ...
                                    className="text-xs ">
                                    <tr>
                                        <th style={{ color: mode === 'dark' ? 'rgb(107, 48, 52)' : 'white' }} scope="col" className="px-6 py-3">
                                            S.No
                                        </th>
                                        <th style={{ color: mode === 'dark' ? 'rgb(107, 48, 52)' : 'white' }} scope="col" className="px-6 py-3">
                                            Thumbnail
                                ...
                                {getAllBlog.length > 0
                                    ? <> {getAllBlog.map((item, index) => {
                                        ...
                                        return (
                                            <tbody key={index}>
                                                <tr className=" border-b-2" style={{ background: mode === 'dark' ? 'rgb(107, 48, 52)' : 'white' }}>
                                                    {/* S.No   */}
                                                    ...
                                                    onClick={()=> deleteBlogs(id)}
                                                     style={{ color: mode === 'dark' ? 'white' : 'black' }} className="px-6 py-4">
                                                        <button className=' px-4 py-1 rounded-lg text-white font-bold bg-red-900'>
                                                            Delete
                                                        </button>
                                                    </td>
                                                </tr>
